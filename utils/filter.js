 ...
 * 26. 8. 22.        Yeong-Huns       legacy → utils 로 이전
 */
 ...
 */
export function limitRepeatingCharacters(text, maxRepeats = 5) {
 ...
 */
export function filterEmojis(text) {
 ...
 */
export function filterUrls(text) {
